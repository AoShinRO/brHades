...
static void mob_readskilldb(const char* basedir, bool silent) {
	if( battle_config.mob_skill_rate == 0 ) {
		ShowStatus("Uso de habilidade do mob desabilitado. Nao e possível ler as habilidades do mob.\n");
		return;
	}
...
static int mob_read_sqlskilldb(void)
{
	...
	if( battle_config.mob_skill_rate == 0 ) {
		ShowStatus("Uso de habilidade do mob desabilitado. Não é possível ler as habilidades do mob.\n");
		return 0;
	}
