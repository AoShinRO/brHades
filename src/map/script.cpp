...
BUILDIN_FUNC(setunitdata)
{
	...
	case BL_MOB: {
		...
		switch (type) {
			case UMOB_SIZE: md->status.size = md->base_status->size = util::clamp<decltype(md->base_status->size)>(value); break;
			case UMOB_LEVEL: md->level = util::clamp<decltype(md->level)>(value); clif_name_area(&md->bl); break;
			case UMOB_HP: md->base_status->hp = util::clamp<decltype(md->base_status->hp)>(value); status_set_hp(bl, util::clamp<decltype(md->base_status->hp)>(value), 0); clif_name_area(&md->bl); break;
			case UMOB_MAXHP: md->base_status->hp = md->base_status->max_hp = util::clamp<decltype(md->base_status->hp)>(value); status_set_maxhp(bl, util::clamp<decltype(md->base_status->hp)>(value), 0); clif_name_area(&md->bl); break;
			case UMOB_MASTERAID: md->master_id = value; break;
			case UMOB_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<short>(value), 0, 0, CLR_TELEPORT); break;
			case UMOB_X: if (!unit_walktoxy(bl, util::clamp<short>(value), md->bl.y, 2)) unit_movepos(bl, util::clamp<short>(value), md->bl.y, 0, 0); break;
			case UMOB_Y: if (!unit_walktoxy(bl, md->bl.x, util::clamp<short>(value), 2)) unit_movepos(bl, md->bl.x, util::clamp<short>(value), 0, 0); break;
			case UMOB_SPEED: md->base_status->speed = util::clamp<decltype(md->base_status->speed)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_MODE:
				...
				unit_refresh(bl);
				break;
			case UMOB_AI: md->special_state.ai = util::clamp<decltype(md->special_state.ai)>(value); break;
			case UMOB_SCOPTION: md->sc.option = util::clamp<decltype(md->sc.option)>(value); break;
			case UMOB_SEX: md->vd->sex = util::clamp<decltype(md->vd->sex)>(value); unit_refresh(bl); break;
			case UMOB_CLASS: status_set_viewdata(bl, util::clamp<decltype(md->vd->class_)>(value)); unit_refresh(bl); break;
			case UMOB_HAIRSTYLE: clif_changelook(bl, LOOK_HAIR, util::clamp<int>(value)); break;
			case UMOB_HAIRCOLOR: clif_changelook(bl, LOOK_HAIR_COLOR, util::clamp<int>(value)); break;
			case UMOB_HEADBOTTOM: clif_changelook(bl, LOOK_HEAD_BOTTOM, util::clamp<int>(value)); break;
			case UMOB_HEADMIDDLE: clif_changelook(bl, LOOK_HEAD_MID, util::clamp<int>(value)); break;
			case UMOB_HEADTOP: clif_changelook(bl, LOOK_HEAD_TOP, util::clamp<int>(value)); break;
			case UMOB_CLOTHCOLOR: clif_changelook(bl, LOOK_CLOTHES_COLOR, util::clamp<int>(value)); break;
			case UMOB_SHIELD: clif_changelook(bl, LOOK_SHIELD, util::clamp<int>(value)); break;
			case UMOB_WEAPON: clif_changelook(bl, LOOK_WEAPON, util::clamp<int>(value)); break;
			case UMOB_LOOKDIR: unit_setdir(bl, util::clamp<uint8>(value)); break;
			case UMOB_CANMOVETICK: md->ud.canmove_tick = value > 0 ? util::clamp<t_tick>(value) : 0; break;
			case UMOB_STR: md->base_status->str = util::clamp<decltype(md->base_status->str)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_AGI: md->base_status->agi = util::clamp<decltype(md->base_status->agi)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_VIT: md->base_status->vit = util::clamp<decltype(md->base_status->vit)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_INT: md->base_status->int_ = util::clamp<decltype(md->base_status->int_)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_DEX: md->base_status->dex = util::clamp<decltype(md->base_status->dex)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_LUK: md->base_status->luk = util::clamp<decltype(md->base_status->luk)>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			...
			case UMOB_ATKRANGE: md->base_status->rhw.range = util::clamp<decltype(md->base_status->rhw.range)>(value); calc_status = true; break;
			case UMOB_ATKMIN: md->base_status->rhw.atk = util::clamp<decltype(md->base_status->rhw.atk)>(value); calc_status = true; break;
			...
			case UMOB_FLEE: md->base_status->flee = util::clamp<decltype(md->base_status->flee)>(value); calc_status = true; break;
			case UMOB_PDODGE: md->base_status->flee2 = util::clamp<decltype(md->base_status->flee2)>(value); calc_status = true; break;
			case UMOB_CRIT: md->base_status->cri = util::clamp<decltype(md->base_status->cri)>(value); calc_status = true; break;
			case UMOB_RACE: md->status.race = md->base_status->race = util::clamp<decltype(md->base_status->race)>(value); break;
			case UMOB_ELETYPE: md->base_status->def_ele = util::clamp<decltype(md->base_status->def_ele)>(value); calc_status = true; break;
			case UMOB_ELELEVEL: md->base_status->ele_lv = util::clamp<decltype(md->base_status->ele_lv)>(value); calc_status = true; break;
			case UMOB_AMOTION: md->base_status->amotion = util::clamp<decltype(md->base_status->amotion)>(value); calc_status = true; break;
			case UMOB_ADELAY: md->base_status->adelay = util::clamp<decltype(md->base_status->adelay)>(value); calc_status = true; break;
			case UMOB_DMOTION: md->base_status->dmotion = util::clamp<decltype(md->base_status->dmotion)>(value); calc_status = true; break;
			case UMOB_TARGETID: {
				if (value==0) {
			...
			case UMOB_ROBE: clif_changelook(bl, LOOK_ROBE, value); break;
			case UMOB_BODY2: clif_changelook(bl, LOOK_BODY2, value); break;
			...
			case UMOB_RES: md->base_status->res = util::clamp<decltype(md->base_status->res)>(value); calc_status = true; break;
	...
	case BL_HOM: {
		...
		switch (type) {
			case UHOM_SIZE: hd->battle_status.size = hd->base_status.size = util::clamp<decltype(hd->base_status.size)>(value); break;
			case UHOM_LEVEL: hd->homunculus.level = util::clamp<decltype(hd->homunculus.level)>(value); break;
			case UHOM_HP: hd->base_status.hp = util::clamp<decltype(hd->base_status.hp)>(value); status_set_hp(bl, util::clamp<decltype(hd->base_status.hp)>(value), 0); break;
			case UHOM_MAXHP: hd->base_status.hp = hd->base_status.max_hp = util::clamp<decltype(hd->base_status.max_hp)>(value); status_set_maxhp(bl, util::clamp<decltype(hd->base_status.max_hp)>(value), 0); break;
			case UHOM_SP: hd->base_status.sp = util::clamp<decltype(hd->base_status.sp)>(value); status_set_sp(bl, util::clamp<decltype(hd->base_status.sp)>(value), 0); break;
			case UHOM_MAXSP: hd->base_status.sp = hd->base_status.max_sp = util::clamp<decltype(hd->base_status.max_sp)>(value); status_set_maxsp(bl, util::clamp<decltype(hd->base_status.max_sp)>(value), 0); break;
			case UHOM_MASTERCID: hd->homunculus.char_id = util::clamp<decltype(hd->homunculus.char_id)>(value); break;
			case UHOM_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<decltype(hd->bl.x)>(value), 0, 0, CLR_TELEPORT); break;
			case UHOM_X: if (!unit_walktoxy(bl, util::clamp<decltype(hd->bl.x)>(value), hd->bl.y, 2)) unit_movepos(bl, util::clamp<decltype(hd->bl.x)>(value), hd->bl.y, 0, 0); break;
			case UHOM_Y: if (!unit_walktoxy(bl, hd->bl.x, util::clamp<decltype(hd->bl.y)>(value), 2)) unit_movepos(bl, hd->bl.x, util::clamp<decltype(hd->bl.y)>(value), 0, 0); break;
			case UHOM_HUNGER: hd->homunculus.hunger = util::clamp<decltype(hd->homunculus.hunger)>(value); clif_send_homdata(*hd, SP_HUNGRY); break;
			case UHOM_INTIMACY: hom_increase_intimacy(hd, util::clamp<decltype(hd->homunculus.intimacy)>(value)); clif_send_homdata(*hd, SP_INTIMATE); break;
			case UHOM_SPEED: hd->base_status.speed = util::clamp<decltype(hd->base_status.speed)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_LOOKDIR: unit_setdir(bl, util::clamp<decltype(hd->ud.dir)>(value)); break;
			case UHOM_CANMOVETICK: hd->ud.canmove_tick = value > 0 ? util::clamp<decltype(hd->ud.canmove_tick)>(value) : 0; break;
			case UHOM_STR: hd->base_status.str = util::clamp<decltype(hd->base_status.str)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_AGI: hd->base_status.agi = util::clamp<decltype(hd->base_status.agi)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_VIT: hd->base_status.vit = util::clamp<decltype(hd->base_status.vit)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_INT: hd->base_status.int_ = util::clamp<decltype(hd->base_status.int_)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_DEX: hd->base_status.dex = util::clamp<decltype(hd->base_status.dex)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_LUK: hd->base_status.luk = util::clamp<decltype(hd->base_status.luk)>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_DMGIMMUNE: hd->ud.immune_attack = value > 0; break;
			case UHOM_ATKRANGE: hd->base_status.rhw.range = util::clamp<decltype(hd->base_status.rhw.range)>(value); calc_status = true; break;
			case UHOM_ATKMIN: hd->base_status.rhw.atk = util::clamp<decltype(hd->base_status.rhw.atk)>(value); calc_status = true; break;
			case UHOM_ATKMAX: hd->base_status.rhw.atk2 = util::clamp<decltype(hd->base_status.rhw.atk2)>(value); calc_status = true; break;
			case UHOM_MATKMIN: hd->base_status.matk_min = util::clamp<decltype(hd->base_status.matk_min)>(value); calc_status = true; break;
			case UHOM_MATKMAX: hd->base_status.matk_max = util::clamp<decltype(hd->base_status.matk_max)>(value); calc_status = true; break;
			case UHOM_DEF: hd->base_status.def = util::clamp<decltype(hd->base_status.def)>(value); calc_status = true; break;
			case UHOM_MDEF: hd->base_status.mdef = util::clamp<decltype(hd->base_status.mdef)>(value); calc_status = true; break;
			case UHOM_HIT: hd->base_status.hit = util::clamp<decltype(hd->base_status.hit)>(value); calc_status = true; break;
			case UHOM_FLEE: hd->base_status.flee = util::clamp<decltype(hd->base_status.flee)>(value); calc_status = true; break;
			case UHOM_PDODGE: hd->base_status.flee2 = util::clamp<decltype(hd->base_status.flee2)>(value); calc_status = true; break;
			case UHOM_CRIT: hd->base_status.cri = util::clamp<decltype(hd->base_status.cri)>(value); calc_status = true; break;
			case UHOM_RACE: hd->battle_status.race = hd->base_status.race = util::clamp<decltype(hd->base_status.race)>(value); break;
			case UHOM_ELETYPE: hd->base_status.def_ele = util::clamp<decltype(hd->base_status.def_ele)>(value); calc_status = true; break;
			case UHOM_ELELEVEL: hd->base_status.ele_lv = util::clamp<decltype(hd->base_status.ele_lv)>(value); calc_status = true; break;
			case UHOM_AMOTION: hd->base_status.amotion = util::clamp<decltype(hd->base_status.amotion)>(value); calc_status = true; break;
			case UHOM_ADELAY: hd->base_status.adelay = util::clamp<decltype(hd->base_status.adelay)>(value); calc_status = true; break;
			case UHOM_DMOTION: hd->base_status.dmotion = util::clamp<decltype(hd->base_status.dmotion)>(value); calc_status = true; break;
			case UHOM_TARGETID: {
				if (value==0) {
	...
	case BL_PET: {
		...
		switch (type) {
			case UPET_SIZE: pd->status.size = util::clamp<decltype(pd->status.size)>(value); break;
			case UPET_LEVEL: pd->pet.level = util::clamp<decltype(pd->pet.level)>(value); break;
			case UPET_HP: pd->status.hp = pd->status.max_hp = util::clamp<decltype(pd->status.hp)>(value); status_set_hp(bl, util::clamp<decltype(pd->status.hp)>(value), 0); break;
			case UPET_MAXHP: pd->status.hp = pd->status.max_hp = util::clamp<decltype(pd->status.max_hp)>(value); status_set_maxhp(bl, util::clamp<decltype(pd->status.max_hp)>(value), 0); break;
			case UPET_MASTERAID: pd->pet.account_id = util::clamp<decltype(pd->pet.account_id)>(value); break;
			case UPET_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<decltype(pd->status.rhw.range)>(value), 0, 0, CLR_TELEPORT); break;
			case UPET_X: if (!unit_walktoxy(bl, util::clamp<decltype(pd->bl.x)>(value), pd->bl.y, 2)) unit_movepos(bl, util::clamp<decltype(pd->bl.x)>(value), pd->bl.y, 0, 0); break;
			case UPET_Y: if (!unit_walktoxy(bl, pd->bl.x, util::clamp<decltype(pd->bl.y)>(value), 2)) unit_movepos(bl, pd->bl.x, util::clamp<decltype(pd->bl.y)>(value), 0, 0); break;
			case UPET_HUNGER: pd->pet.hungry = std::clamp(util::clamp<decltype(pd->pet.hungry)>(value), static_cast<decltype(pd->pet.hungry)>(0), static_cast<decltype(pd->pet.hungry)>(100)); clif_send_petdata(map_id2sd(pd->pet.account_id), pd, 2, pd->pet.hungry); break;
			case UPET_INTIMACY: pet_set_intimate(pd, util::clamp<decltype(pd->pet.intimate)>(value)); clif_send_petdata(map_id2sd(pd->pet.account_id), pd, 1, pd->pet.intimate); break;
			case UPET_SPEED: pd->status.speed = util::clamp<decltype(pd->status.speed)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_LOOKDIR: unit_setdir(bl, util::clamp<decltype(pd->status.rhw.range)>(value)); break;
			case UPET_CANMOVETICK: pd->ud.canmove_tick = value > 0 ? util::clamp<decltype(pd->ud.canmove_tick)>(value) : 0; break;
			case UPET_STR: pd->status.str = util::clamp<decltype(pd->status.str)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_AGI: pd->status.agi = util::clamp<decltype(pd->status.agi)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_VIT: pd->status.vit = util::clamp<decltype(pd->status.vit)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_INT: pd->status.int_ = util::clamp<decltype(pd->status.int_)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_DEX: pd->status.dex = util::clamp<decltype(pd->status.dex)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_LUK: pd->status.luk = util::clamp<decltype(pd->status.luk)>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_DMGIMMUNE: pd->ud.immune_attack = value > 0; break;
			case UPET_ATKRANGE: pd->status.rhw.range = util::clamp<decltype(pd->status.rhw.range)>(value); break;
			case UPET_ATKMIN: pd->status.rhw.atk = util::clamp<decltype(pd->status.rhw.atk)>(value); break;
			case UPET_ATKMAX: pd->status.rhw.atk2 = util::clamp<decltype(pd->status.rhw.atk2)>(value); break;
			case UPET_MATKMIN: pd->status.matk_min = util::clamp<decltype(pd->status.matk_min)>(value); break;
			case UPET_MATKMAX: pd->status.matk_max = util::clamp<decltype(pd->status.matk_max)>(value); break;
			case UPET_DEF: pd->status.def = util::clamp<decltype(pd->status.def)>(value); break;
			case UPET_MDEF: pd->status.mdef = util::clamp<decltype(pd->status.mdef)>(value); break;
			case UPET_HIT: pd->status.hit = util::clamp<decltype(pd->status.hit)>(value); break;
			case UPET_FLEE: pd->status.flee = util::clamp<decltype(pd->status.flee)>(value); break;
			case UPET_PDODGE: pd->status.flee2 = util::clamp<decltype(pd->status.flee2)>(value); break;
			case UPET_CRIT: pd->status.cri = util::clamp<decltype(pd->status.cri)>(value); break;
			case UPET_RACE: pd->status.race = util::clamp<decltype(pd->status.race)>(value); break;
			case UPET_ELETYPE: pd->status.def_ele = util::clamp<decltype(pd->status.def_ele)>(value); break;
			case UPET_ELELEVEL: pd->status.ele_lv = util::clamp<decltype(pd->status.ele_lv)>(value); break;
			case UPET_AMOTION: pd->status.amotion = util::clamp<decltype(pd->status.amotion)>(value); break;
			case UPET_ADELAY: pd->status.adelay = util::clamp<decltype(pd->status.adelay)>(value); break;
			case UPET_DMOTION: pd->status.dmotion = util::clamp<decltype(pd->status.dmotion)>(value); break;
	...
	case BL_MER: {
		...
		switch (type) {
			case UMER_SIZE: mc->battle_status.size = mc->base_status.size = util::clamp<decltype(mc->base_status.size)>(value); break;
			case UMER_HP: mc->base_status.hp = util::clamp<decltype(mc->base_status.hp)>(value); status_set_hp(bl, util::clamp<decltype(mc->base_status.hp)>(value), 0); break;
			case UMER_MAXHP: mc->base_status.hp = mc->base_status.max_hp = util::clamp<decltype(mc->base_status.hp)>(value); status_set_maxhp(bl, util::clamp<decltype(mc->base_status.hp)>(value), 0); break;
			case UMER_MASTERCID: mc->mercenary.char_id = util::clamp<decltype(mc->mercenary.char_id)>(value); break;
			case UMER_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<decltype(mc->bl.m)>(value), 0, 0, CLR_TELEPORT); break;
			case UMER_X: if (!unit_walktoxy(bl, util::clamp<decltype(mc->bl.x)>(value), mc->bl.y, 2)) unit_movepos(bl, util::clamp<decltype(mc->bl.x)>(value), mc->bl.y, 0, 0); break;
			case UMER_Y: if (!unit_walktoxy(bl, mc->bl.x, util::clamp<decltype(mc->bl.y)>(value), 2)) unit_movepos(bl, mc->bl.x, util::clamp<decltype(mc->bl.y)>(value), 0, 0); break;
			case UMER_KILLCOUNT: mc->mercenary.kill_count = util::clamp<decltype(mc->mercenary.kill_count)>(value); break;
			case UMER_LIFETIME: mc->mercenary.life_time = util::clamp<decltype(mc->mercenary.life_time)>(value); break;
			case UMER_SPEED: mc->base_status.speed = util::clamp<decltype(mc->base_status.speed)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_LOOKDIR: unit_setdir(bl, util::clamp<decltype(mc->ud.dir)>(value)); break;
			case UMER_CANMOVETICK: mc->ud.canmove_tick = value > 0 ? util::clamp<decltype(mc->ud.canmove_tick)>(value) : 0; break;
			case UMER_STR: mc->base_status.str = util::clamp<decltype(mc->base_status.str)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_AGI: mc->base_status.agi = util::clamp<decltype(mc->base_status.agi)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_VIT: mc->base_status.vit = util::clamp<decltype(mc->base_status.vit)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_INT: mc->base_status.int_ = util::clamp<decltype(mc->base_status.int_)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_DEX: mc->base_status.dex = util::clamp<decltype(mc->base_status.dex)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_LUK: mc->base_status.luk = util::clamp<decltype(mc->base_status.luk)>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_DMGIMMUNE: mc->ud.immune_attack = value > 0; break;
			case UMER_ATKRANGE: mc->base_status.rhw.range = util::clamp<decltype(mc->base_status.rhw.range)>(value); calc_status = true; break;
			case UMER_ATKMIN: mc->base_status.rhw.atk = util::clamp<decltype(mc->base_status.rhw.atk)>(value); calc_status = true; break;
			case UMER_ATKMAX: mc->base_status.rhw.atk2 = util::clamp<decltype(mc->base_status.rhw.atk2)>(value); calc_status = true; break;
			case UMER_MATKMIN: mc->base_status.matk_min = util::clamp<decltype(mc->base_status.matk_min)>(value); calc_status = true; break;
			case UMER_MATKMAX: mc->base_status.matk_max = util::clamp<decltype(mc->base_status.matk_max)>(value); calc_status = true; break;
			case UMER_DEF: mc->base_status.def = util::clamp<decltype(mc->base_status.def)>(value); calc_status = true; break;
			case UMER_MDEF: mc->base_status.mdef = util::clamp<decltype(mc->base_status.mdef)>(value); calc_status = true; break;
			case UMER_HIT: mc->base_status.hit = util::clamp<decltype(mc->base_status.hit)>(value); calc_status = true; break;
			case UMER_FLEE: mc->base_status.flee = util::clamp<decltype(mc->base_status.flee)>(value); calc_status = true; break;
			case UMER_PDODGE: mc->base_status.flee2 = util::clamp<decltype(mc->base_status.flee2)>(value); calc_status = true; break;
			case UMER_CRIT: mc->base_status.cri = util::clamp<decltype(mc->base_status.cri)>(value); calc_status = true; break;
			case UMER_RACE: mc->battle_status.race = mc->base_status.race = util::clamp<decltype(mc->battle_status.race)>(value); break;
			case UMER_ELETYPE: mc->base_status.def_ele = util::clamp<decltype(mc->base_status.def_ele)>(value); calc_status = true; break;
			case UMER_ELELEVEL: mc->base_status.ele_lv = util::clamp<decltype(mc->base_status.ele_lv)>(value); calc_status = true; break;
			case UMER_AMOTION: mc->base_status.amotion = util::clamp<decltype(mc->base_status.amotion)>(value); calc_status = true; break;
			case UMER_ADELAY: mc->base_status.adelay = util::clamp<decltype(mc->base_status.adelay)>(value); calc_status = true; break;
			case UMER_DMOTION: mc->base_status.dmotion = util::clamp<decltype(mc->base_status.dmotion)>(value); calc_status = true; break;
			case UMER_TARGETID: {
				if (value==0) {
	...
	case BL_ELEM: {
		...
		switch (type) {
			case UELE_SIZE: ed->battle_status.size = ed->base_status.size = util::clamp<decltype(ed->battle_status.size)>(value); break;
			case UELE_HP: ed->base_status.hp = util::clamp<decltype(ed->base_status.hp)>(value); status_set_hp(bl, util::clamp<decltype(ed->base_status.hp)>(value), 0); break;
			case UELE_MAXHP: ed->base_status.hp = ed->base_status.max_hp = util::clamp<decltype(ed->base_status.max_hp)>(value); status_set_maxhp(bl, util::clamp<decltype(ed->base_status.max_hp)>(value), 0); break;
			case UELE_SP: ed->base_status.sp = util::clamp<decltype(ed->base_status.sp)>(value); status_set_sp(bl, util::clamp<decltype(ed->base_status.sp)>(value), 0); break;
			case UELE_MAXSP: ed->base_status.sp = ed->base_status.max_sp = util::clamp<decltype(ed->base_status.max_sp)>(value); status_set_maxsp(bl, util::clamp<decltype(ed->base_status.max_sp)>(value), 0); break;
			case UELE_MASTERCID: ed->elemental.char_id = util::clamp<decltype(ed->elemental.char_id)>(value); break;
			case UELE_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<decltype(ed->bl.id)>(value), 0, 0, CLR_TELEPORT); break;
			case UELE_X: if (!unit_walktoxy(bl, util::clamp<decltype(ed->bl.x)>(value), ed->bl.y, 2)) unit_movepos(bl, util::clamp<decltype(ed->bl.x)>(value), ed->bl.y, 0, 0); break;
			case UELE_Y: if (!unit_walktoxy(bl, ed->bl.x, util::clamp<decltype(ed->bl.y)>(value), 2)) unit_movepos(bl, ed->bl.x, util::clamp<decltype(ed->bl.y)>(value), 0, 0); break;
			case UELE_LIFETIME: ed->elemental.life_time = util::clamp<decltype(ed->elemental.life_time)>(value); break;
			case UELE_MODE: ed->elemental.mode = (enum e_mode)value; calc_status = true; break;
			case UELE_SPEED: ed->base_status.speed = util::clamp<decltype(ed->base_status.speed)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_LOOKDIR: unit_setdir(bl, util::clamp<decltype(ed->ud.dir)>(value)); break;
			case UELE_CANMOVETICK: ed->ud.canmove_tick = value > 0 ? util::clamp<decltype(ed->ud.canmove_tick)>(value) : 0; break;
			case UELE_STR: ed->base_status.str = util::clamp<decltype(ed->base_status.str)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_AGI: ed->base_status.agi = util::clamp<decltype(ed->base_status.agi)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_VIT: ed->base_status.vit = util::clamp<decltype(ed->base_status.vit)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_INT: ed->base_status.int_ = util::clamp<decltype(ed->base_status.int_)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_DEX: ed->base_status.dex = util::clamp<decltype(ed->base_status.dex)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_LUK: ed->base_status.luk = util::clamp<decltype(ed->base_status.luk)>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_DMGIMMUNE: ed->ud.immune_attack = value > 0; break;
			case UELE_ATKRANGE: ed->base_status.rhw.range = util::clamp<decltype(ed->base_status.rhw.range)>(value); calc_status = true; break;
			case UELE_ATKMIN: ed->base_status.rhw.atk = util::clamp<decltype(ed->base_status.rhw.atk)>(value); calc_status = true; break;
			case UELE_ATKMAX: ed->base_status.rhw.atk2 = util::clamp<decltype(ed->base_status.rhw.atk2)>(value); calc_status = true; break;
			case UELE_MATKMIN: ed->base_status.matk_min = util::clamp<decltype(ed->base_status.matk_min)>(value); calc_status = true; break;
			case UELE_MATKMAX: ed->base_status.matk_max = util::clamp<decltype(ed->base_status.matk_max)>(value); calc_status = true; break;
			case UELE_DEF: ed->base_status.def = util::clamp<decltype(ed->base_status.def)>(value); calc_status = true; break;
			case UELE_MDEF: ed->base_status.mdef = util::clamp<decltype(ed->base_status.mdef)>(value); calc_status = true; break;
			case UELE_HIT: ed->base_status.hit = util::clamp<decltype(ed->base_status.hit)>(value); calc_status = true; break;
			case UELE_FLEE: ed->base_status.flee = util::clamp<decltype(ed->base_status.flee)>(value); calc_status = true; break;
			case UELE_PDODGE: ed->base_status.flee2 = util::clamp<decltype(ed->base_status.flee2)>(value); calc_status = true; break;
			case UELE_CRIT: ed->base_status.cri = util::clamp<decltype(ed->base_status.cri)>(value); calc_status = true; break;
			case UELE_RACE: ed->battle_status.race = ed->base_status.race = util::clamp<decltype(ed->battle_status.race)>(value); break;
			case UELE_ELETYPE: ed->base_status.def_ele = util::clamp<decltype(ed->base_status.def_ele)>(value); calc_status = true; break;
			case UELE_ELELEVEL: ed->base_status.ele_lv = util::clamp<decltype(ed->base_status.ele_lv)>(value); calc_status = true; break;
			case UELE_AMOTION: ed->base_status.amotion = util::clamp<decltype(ed->base_status.amotion)>(value); calc_status = true; break;
			case UELE_ADELAY: ed->base_status.adelay = util::clamp<decltype(ed->base_status.adelay)>(value); calc_status = true; break;
			case UELE_DMOTION: ed->base_status.dmotion = util::clamp<decltype(ed->base_status.dmotion)>(value); calc_status = true; break;
			case UELE_TARGETID: {
				if (value==0) {
	...
	case BL_NPC: {
		...
		switch (type) {
			case UNPC_HP: nd->status.hp = util::clamp<decltype(nd->status.hp)>(value); status_set_hp(bl, util::clamp<decltype(nd->status.hp)>(value), 0); break;
			case UNPC_MAXHP: nd->status.hp = nd->status.max_hp = util::clamp<decltype(nd->status.max_hp)>(value); status_set_maxhp(bl, util::clamp<decltype(nd->status.max_hp)>(value), 0); break;
			case UNPC_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, util::clamp<decltype(nd->bl.m)> (value), 0, 0, CLR_TELEPORT); break; // Assuming nd->bl.map is the correct type
			case UNPC_X: if (!unit_walktoxy(bl, util::clamp<decltype(nd->bl.x)>(value), nd->bl.y, 2)) unit_movepos(bl, util::clamp<decltype(nd->bl.x)>(value), nd->bl.x, 0, 0); break;
			case UNPC_Y: if (!unit_walktoxy(bl, nd->bl.x, util::clamp<decltype(nd->bl.y)>(value), 2)) unit_movepos(bl, nd->bl.x, util::clamp<decltype(nd->bl.y)>(value), 0, 0); break;
			case UNPC_LOOKDIR: unit_setdir(bl, util::clamp<decltype(nd->ud.dir)>(value)); break; // Assuming nd->status.lookdir exists and is the correct type
			case UNPC_STR: nd->params.str = util::clamp<decltype(nd->params.str)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_AGI: nd->params.agi = util::clamp<decltype(nd->params.agi)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_VIT: nd->params.vit = util::clamp<decltype(nd->params.vit)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_INT: nd->params.int_ = util::clamp<decltype(nd->params.int_)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_DEX: nd->params.dex = util::clamp<decltype(nd->params.dex)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_LUK: nd->params.luk = util::clamp<decltype(nd->params.luk)>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_PLUSALLSTAT: nd->stat_point = util::clamp<decltype(nd->stat_point)>(value); break;
			case UNPC_ATKRANGE: nd->status.rhw.range = util::clamp<decltype(nd->status.rhw.range)>(value); break;
			case UNPC_ATKMIN: nd->status.rhw.atk = util::clamp<decltype(nd->status.rhw.atk)>(value); break;
			case UNPC_ATKMAX: nd->status.rhw.atk2 = util::clamp<decltype(nd->status.rhw.atk2)>(value); break;
			case UNPC_MATKMIN: nd->status.matk_min = util::clamp<decltype(nd->status.matk_min)>(value); break;
			case UNPC_MATKMAX: nd->status.matk_max = util::clamp<decltype(nd->status.matk_max)>(value); break;
			case UNPC_DEF: nd->status.def = util::clamp<decltype(nd->status.def)>(value); break;
			case UNPC_MDEF: nd->status.mdef = util::clamp<decltype(nd->status.mdef)>(value); break;
			case UNPC_HIT: nd->status.hit = util::clamp<decltype(nd->status.hit)>(value); break;
			case UNPC_FLEE: nd->status.flee = util::clamp<decltype(nd->status.flee)>(value); break;
			case UNPC_PDODGE: nd->status.flee2 = util::clamp<decltype(nd->status.flee2)>(value); break;
			case UNPC_CRIT: nd->status.cri = util::clamp<decltype(nd->status.cri)>(value); break;
			case UNPC_RACE: nd->status.race = util::clamp<decltype(nd->status.race)>(value); break;
			case UNPC_ELETYPE: nd->status.def_ele = util::clamp<decltype(nd->status.def_ele)>(value); break;
			case UNPC_ELELEVEL: nd->status.ele_lv = util::clamp<decltype(nd->status.ele_lv)>(value); break;
			case UNPC_AMOTION: nd->status.amotion = util::clamp<decltype(nd->status.amotion)>(value); break;
			case UNPC_ADELAY: nd->status.adelay = util::clamp<decltype(nd->status.adelay)>(value); break;
			case UNPC_DMOTION: nd->status.dmotion = util::clamp<decltype(nd->status.dmotion)>(value); break;
			case UNPC_SEX: nd->vd.sex = util::clamp<decltype(nd->vd.sex)>(value); unit_refresh(bl); break;
			case UNPC_CLASS: npc_setclass(nd, util::clamp<decltype(nd->class_)>(value)); break; // Assuming nd->class_ exists and is the correct type
			case UNPC_HAIRSTYLE: clif_changelook(bl, LOOK_HAIR, util::clamp<decltype(nd->vd.hair_style)>(value)); break; // Assuming nd->vd.hair exists and is the correct type
			case UNPC_HAIRCOLOR: clif_changelook(bl, LOOK_HAIR_COLOR, util::clamp<decltype(nd->vd.hair_color)>(value)); break; // Assuming nd->vd.hair_color exists and is the correct type
			case UNPC_HEADBOTTOM: clif_changelook(bl, LOOK_HEAD_BOTTOM, util::clamp<decltype(nd->vd.head_bottom)>(value)); break; // Assuming nd->vd.head_bottom exists and is the correct type
			case UNPC_HEADMIDDLE: clif_changelook(bl, LOOK_HEAD_MID, util::clamp<decltype(nd->vd.head_mid)>(value)); break; // Assuming nd->vd.head_mid exists and is the correct type
			case UNPC_HEADTOP: clif_changelook(bl, LOOK_HEAD_TOP, util::clamp<decltype(nd->vd.head_top)>(value)); break; // Assuming nd->vd.head_top exists and is the correct type
			case UNPC_CLOTHCOLOR: clif_changelook(bl, LOOK_CLOTHES_COLOR, util::clamp<decltype(nd->vd.cloth_color)>(value)); break; // Assuming nd->vd.clothes_color exists and is the correct type
			case UNPC_SHIELD: clif_changelook(bl, LOOK_SHIELD, util::clamp<decltype(nd->vd.shield)>(value)); break; // Assuming nd->vd.shield exists and is the correct type
			case UNPC_WEAPON: clif_changelook(bl, LOOK_WEAPON, util::clamp<decltype(nd->vd.weapon)>(value)); break; // Assuming nd->vd.weapon exists and is the correct type
			case UNPC_ROBE: clif_changelook(bl, LOOK_ROBE, util::clamp<decltype(nd->vd.robe)>(value)); break; // Assuming nd->vd.robe exists and is the correct type
			case UNPC_BODY2: clif_changelook(bl, LOOK_BODY2, util::clamp<decltype(nd->vd.body_style)>(value)); break; // Assuming nd->vd.body2 exists and is the correct type
			case UNPC_DEADSIT: nd->vd.dead_sit = util::clamp<decltype(nd->vd.dead_sit)>(value); unit_refresh(bl); break;
