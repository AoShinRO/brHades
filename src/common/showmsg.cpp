...
///////////////////////////////////////////////////////////////////////////////
static int32 VFPRINTF(HANDLE handle, const std::string_view fmt, va_list argptr)
{
	/////////////////////////////////////////////////////////////////
...
static int32 FPRINTF(HANDLE handle, const std::string_view fmt, ...)
{
	int32 ret;
	va_list argptr;
	va_start(argptr, fmt);
...
static int32 VFPRINTF(FILE *file, const std::string_view fmt, va_list argptr)
{
	char *p, *q;
	NEWBUF(tempbuf); // temporary buffer
...
static int32 FPRINTF(FILE *file, const std::string_view fmt, ...)
{
	int32 ret;
	va_list argptr;
	va_start(argptr, fmt);
...
int32 _vShowMessage(enum msg_type flag, const std::string_view string, va_list ap)
{
	va_list apcopy;
	char prefix[100];
