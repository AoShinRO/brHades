...
#ifdef LOG_MEMMGR
	if(count == 0) {
		ShowInfo("Gerenciador de mem�ria: Nenhum vazamento de mem�ria encontrado.\n");
	} else {
		ShowWarning("Gerenciador de mem�ria: Vazamentos de mem�ria encontrados e corrigidos.\n");
		fclose(log_fp);
	}
#endif /* LOG_MEMMGR */
}
